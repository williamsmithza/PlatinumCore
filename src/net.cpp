...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("PlatinumCore-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("PlatinumCore-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PlatinumCore " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("PlatinumCore-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("PlatinumCore-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("PlatinumCore-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("PlatinumCore-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PlatinumCore is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("PlatinumCore-start");
