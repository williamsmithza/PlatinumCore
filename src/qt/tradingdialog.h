...
private slots:
    ...
    void on_BuyPLTCR_clicked();
    void on_SellPLTCRBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputPLTCR_textChanged(const QString &arg1);
    ...
    QString BuyPLTCR(QString OrderType, double Quantity, double Rate);
    QString SellPLTCR(QString OrderType, double Quantity, double Rate);
