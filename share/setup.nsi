...
!define URL http://www.PlatinumCore.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/PlatinumCore.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\PlatinumCore-qt.exe
...
OutFile PlatinumCore-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/PlatinumCore-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/PlatinumCored.exe
    ...
    #Delete /REBOOTOK $INSTDIR\PlatinumCore.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\PlatinumCore-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "PlatinumCore"
